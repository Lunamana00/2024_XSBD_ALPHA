...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFractProjectile_Statics::NewProp_Tracer = { "Tracer", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFractProjectile, Tracer), Z_Construct_UClass_UParticleSystem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Tracer_MetaData), NewProp_Tracer_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFractProjectile_Statics::NewProp_TracerComponent = { "TracerComponent", nullptr, (EPropertyFlags)0x0040000000080009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFractProjectile, TracerComponent), Z_Construct_UClass_UParticleSystemComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_TracerComponent_MetaData), NewProp_TracerComponent_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFractProjectile_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFractProjectile_Statics::NewProp_Tracer,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFractProjectile_Statics::NewProp_TracerComponent,
};
...
struct Z_CompiledInDeferFile_FID_Alpha_Source_Alpha_Public_Weapons_FractProjectile_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AFractProjectile, AFractProjectile::StaticClass, TEXT("AFractProjectile"), &Z_Registration_Info_UClass_AFractProjectile, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AFractProjectile), 3083597403U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Alpha_Source_Alpha_Public_Weapons_FractProjectile_h_464607539(TEXT("/Script/Alpha"),
